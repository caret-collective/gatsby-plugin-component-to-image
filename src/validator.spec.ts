...
describe('Validator', () => {
	...
	describe('validateDefaultOptions', () => {
		it.concurrent('should replace an empty object with default options', async () => {
		...
		it.concurrent('should replace undefined options with default options', async () => {
			const inputDefaultOptions = {
				verbose: undefined,
				component: undefined,
				context: undefined,
		...
		describe('verbose validation', () => {
			...
			it.concurrent(`should throw an error for ${PROPERTY_NAME} of invalid type`, async () => {
				const inputDefaultOptions = {
					[PROPERTY_NAME]: 'bruh',
				};
			...
			it.concurrent(`should convert string ${PROPERTY_NAME} to boolean`, async () => {
				const inputDefaultOptions = {
					[PROPERTY_NAME]: 'true',
				};
			...
			it.concurrent(`should not throw an error for boolean ${PROPERTY_NAME}`, async () => {
				const inputDefaultOptions = {
					[PROPERTY_NAME]: true,
				};
		...
		describe('component validation', () => {
			...
			it.concurrent(`should throw an error for empty ${PROPERTY_NAME} string`, async () => {
				const inputDefaultOptions = {
					[PROPERTY_NAME]: '',
				};
			...
			it.concurrent(`should not throw an error for non-empty ${PROPERTY_NAME} string`, async () => {
				const inputDefaultOptions = {
		...
		describe('context validation', () => {
			...
			it.concurrent(`should not throw an error for valid ${PROPERTY_NAME}`, async () => {
				const inputDefaultOptions = {
		...
		describe('size validation', () => {
			...
			describe('width validation', () => {
				...
				it.concurrent(`should throw an error for non-integer ${PROPERTY_NAME}`, async () => {
					const inputDefaultOptions = {
						size: {
							width: Math.PI,
							height: 630,
				...
				it.concurrent(`should throw an error for ${PROPERTY_NAME} below the minimum size`, async () => {
					const inputDefaultOptions = {
						size: {
							width: 0,
							height: 630,
				...
				it.concurrent(`should throw an error for ${PROPERTY_NAME} above the maximum size`, async () => {
					const inputDefaultOptions = {
						size: {
							width: 20000,
							height: 630,
				...
				it.concurrent(`should convert string ${PROPERTY_NAME} to number`, async () => {
					const inputDefaultOptions = {
						size: {
							width: '1337',
							height: 630,
		...
		describe('type validation', () => {
			...
			it.concurrent(`should throw an error for invalid ${PROPERTY_NAME} option`, async () => {
				const inputDefaultOptions = {
					[PROPERTY_NAME]: 'invalid' as const,
				};
			...
			it.concurrent(`should convert string ${PROPERTY_NAME} to lowercase`, async () => {
				const inputDefaultOptions = {
		...
		describe('quality validation', () => {
			...
			it.concurrent(`should throw an error for ${PROPERTY_NAME} below the minimum quality`, async () => {
				const inputDefaultOptions = {
					[PROPERTY_NAME]: -1,
				};
			...
			it.concurrent(`should throw an error for ${PROPERTY_NAME} above the maximum quality`, async () => {
				const inputDefaultOptions = {
					[PROPERTY_NAME]: 101,
				};
	...
	describe('validateJobOptions', () => {
		it.concurrent('should not throw an error for valid job options', async () => {
			expect(() => {
		...
		describe('pagePath validation', () => {
			...
			it.concurrent(`should throw an error for missing ${PROPERTY_NAME}`, async () => {
